...
class SLR(Scene):
    ...
    def construct(self):
        ...
        # Add dot mobjects
        dot1 = Dot(point=np.array([-5, -2, 0]), radius=0.08, color = BLUE)
        dot2 = Dot(point=np.array([-4, -1.5, 0]), radius=0.08, color = BLUE)
        dot3 = Dot(point=np.array([-3, -1, 0]), radius=0.08, color = BLUE)
        dot4 = Dot(point=np.array([-2, -0.5, 0]), radius=0.08, color = BLUE)
        dot5 = Dot(point=np.array([-1, 0, 0]), radius=0.08, color = BLUE)
        dot6 = Dot(point=np.array([0, 0.5, 0]), radius=0.08, color = BLUE)
        dot7 = Dot(point=np.array([1, 1.5, 0]), radius=0.08, color = BLUE)
        dot8 = Dot(point=np.array([2, 2, 0]), radius=0.08, color = BLUE)
        ...
        # Line of best fit
        func_graph_cube= ax.plot(lambda x : x + x, x_range = [0, 5], color = GREEN)
